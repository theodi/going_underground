  ...
  describe App, :vcr do
    ...
    it 'gets results for heatmap', :vcr do
      ...
      expect(json).to eq([
        ...
        {"segment"=>365, "station"=>"seven_sisters", "direction"=>"southbound", "load"=>24.44756728778468},
        ...
        {"segment"=>893, "station"=>"seven_sisters", "direction"=>"southbound", "load"=>25.250743153394264},
        {"segment"=>1026, "station"=>"kings_cross_st_pancras", "direction"=>"northbound", "load"=>89.16173716329966},
        {"segment"=>1146, "station"=>"kings_cross_st_pancras", "direction"=>"northbound", "load"=>89.70682693250033},
        ...
        {"segment"=>1766, "station"=>"vauxhall", "direction"=>"northbound", "load"=>17.181602698739795},
        {"segment"=>1793, "station"=>"pimlico", "direction"=>"southbound", "load"=>53.23052300174797},
        {"segment"=>1794, "station"=>"vauxhall", "direction"=>"northbound", "load"=>12.151785714285714},
        {"segment"=>1878, "station"=>"stockwell", "direction"=>"northbound", "load"=>13.124603174603173},
        {"segment"=>1881, "station"=>"vauxhall", "direction"=>"southbound", "load"=>43.350831430318934},
        {"segment"=>1892, "station"=>"stockwell", "direction"=>"northbound", "load"=>10.239285714285714},
        {"segment"=>1963, "station"=>"stockwell", "direction"=>"southbound", "load"=>35.552784412666455},
        {"segment"=>1999, "station"=>"stockwell", "direction"=>"southbound", "load"=>24.616371909340657}
      ])
    end
  end
end
