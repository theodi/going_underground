module SirHandel
  describe App, :vcr do
    ...
    it 'gets a result for a heatmap for a time period', :vcr do
      get '/heatmap/2015-09-23T17:00:00Z/2015-09-23T17:30:00Z.json'

      json = JSON.parse(last_response.body)

      expect(json.count).to eq(7)
      expect(json.first).to eq([
        {"segment"=>1894, "station"=>"brixton", "direction"=>"northbound", "load"=>11.409491038022043},
        {"segment"=>1999, "station"=>"stockwell", "direction"=>"southbound", "load"=>27.70859151599568},
        {"segment"=>1881, "station"=>"vauxhall", "direction"=>"southbound", "load"=>34.87608467004879},
        {"segment"=>1793, "station"=>"pimlico", "direction"=>"southbound", "load"=>53.23052300174797},
        {"segment"=>1681, "station"=>"victoria", "direction"=>"southbound", "load"=>57.001145337653135},
        {"segment"=>1565, "station"=>"green_park", "direction"=>"southbound", "load"=>97.07543448715087},
        {"segment"=>1487, "station"=>"oxford_circus", "direction"=>"southbound", "load"=>94.94368275515336},
        ...
        {"segment"=>2002, "station"=>nil, "direction"=>"northbound", "load"=>18.22630493576741}
      ])
