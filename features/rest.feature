...
Feature: REST it up
  ...
  Scenario: Support DateTime durations in URLs
    ...
    And the JSON response should have "$.signals[0]results[0].timestamp" with the text "2015-12-11T06:00:00.000+00:00"
    And the JSON response should have "$.signals[0]results[3].timestamp" with the text "2015-12-11T09:00:00.000+00:00"

  Scenario: Get raw data
    When I send a GET request to "signals/train-speed/2015-12-11T09:00:00/2015-12-11T11:00:00"
    Then the response status should be "200"
    And the JSON response should have "$.signals[0].name" with the text "Train Speed"
    And the JSON response should have "$.signals[0]results[0].timestamp" with the text "2015-12-11T09:01:00.234+00:00"
    And the JSON response should have "$.signals[0]results[1].timestamp" with the text "2015-12-11T09:02:01.078+00:00"
  ...
  Scenario: Allow intervals to be set as query strings
    ...
    Then the response status should be "200"
    And the JSON response should have "$.signals[0]results[0].timestamp" with the text "2015-12-11T06:00:00.000+00:00"
    And the JSON response should have "$.signals[0]results[1].timestamp" with the text "2015-12-11T06:10:55.000+00:00"
  ...
  Scenario: Allow two signals to be set
    ...
    And the JSON response should have "$.signals[1]results[0].timestamp" with the text "2015-12-11T06:00:00.000+00:00"
    And the JSON response should have "$.signals[1]results[1].timestamp" with the text "2015-12-11T06:10:55.000+00:00"
